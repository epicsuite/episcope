...
class TubeDisplay(Display):
    def __init__(self):
        ...
        self.lut.RGBPoints = [0.7796000000000001, 0.007843, 0.219608, 0.345098, 314.455683998, 0.01178, 0.286536, 0.449427, 628.1317679959999, 0.015702, 0.35328, 0.553479, 941.8103516042, 0.01767, 0.396586, 0.622376, 1255.4864356022001, 0.021115, 0.4402, 0.690688, 1569.1625196002, 0.11757, 0.503191, 0.722184, 1882.8386035982, 0.214625, 0.565859, 0.753633, 2196.5146875962, 0.336671, 0.615071, 0.78316, 2510.1921963720138, 0.457978, 0.663975, 0.812503, 2823.8693552024, 0.556401, 0.703345, 0.836125, 3137.5454392004, 0.65421, 0.742714, 0.859669, 3451.2215231984, 0.736886, 0.782084, 0.881323, 3764.8976071964003, 0.81827, 0.821638, 0.903068, 4078.5761908045997, 0.873387, 0.864944, 0.92669, 4392.2522748026, 0.927536, 0.907605, 0.949988, 4705.9283588006, 0.964937, 0.9391, 0.967705, 5000.0, 1.0, 0.968627, 0.984314]
    ...
    def representation_properties(self):
        ...
        if self.variable == "":
            ...
            variable_properties["AmbientColor"] = [0.00784313725490196, 0.2196078431372549, 0.34509803921568627]
            variable_properties["DiffuseColor"] = [0.00784313725490196, 0.2196078431372549, 0.34509803921568627]
        else:
